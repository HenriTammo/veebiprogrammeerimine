  ...
  //pildi üleslaadimise osa
	...
	if(isset($_POST["submitPic"])) {
		...
		// kui kõik korras, laeme üles
			...
			//sõltuvalt faili tüübist loome pildi objekti
			...
			//kopeeri cesimärgi pikslid pildile 
			imagecopy($myImage, $waterMark, $waterMarkPosX, $waterMarkPosY, 0, 0, $waterMarkWidth, $waterMarkHeight);
			
			//lisame ka teksti
			$textToImage = "TLÜ veebiprogrammeerimine";
			$textColor = imagecolorallocatealpha($myImage, 225,225,225, 60);
			//alpha ... 127
...
?>
	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
	  ...
	  <br>
	  <label>Alt tekst: </label><input type = "tekst" name ="altText">
	  <br>
	  ...
	  <input type="radio" name="privacy" value="3"><label>Isiklik</label>;
	  <br>
