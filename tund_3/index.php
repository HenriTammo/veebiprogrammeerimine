<?php
  //echo "Siin on minu esimene PHP!";
   ...
   //echo $weekDayNamesET; (echo to string array error)
   //var_dump ($weekDayNamesET); (korrektne viis array echomiseks, ARRAY ALGAB 0-st)
   //echo $weekDayNamesET [0]; annab esmaspäeva
   $hourNow = date("H");
   //echo $hourNow; 
   $partOfDay = "";
   if ($hourNow < 8) {
...
<body>
  ...
  <p> Link minu kaasüliõpilase lehele <a href="../../../../~kristre"  target="_blank"> Kristjan Treimann</a> </P>
